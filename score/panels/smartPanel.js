...
/* 导入所有模块 */
import { probHasShan, probHasWuxie, probHasTao, probHasSha, probHasJiu, inferHand } from '../modules/misc/handInference.js';
import { keepScore, recommendKeep, suitValue, cardKeepValue } from '../modules/strategy/keepStrategy.js';
import { equipScarcity, equipValue, sortEquips, isKeyEquip } from '../modules/misc/equipScarcity.js';
import { predictCombo, predictTaoNeed, multiTurnScore } from '../modules/misc/multiTurnPlan.js';
...
import { analyzeOpponentPref, counterStrategy, predictOpponentNext } from '../modules/strategy/counterStrategy.js';
import { evaluateSituation, describeSituation, situationStrategyBonus } from '../modules/misc/situationEval.js';
import { shaHitRate, wuxieRisk, duelWinRate, riskScore, describeRisk, taoNecessity } from '../modules/misc/riskQuant.js';
import { taoTiming, wuxieTiming, jiuTiming, resourceScarcity } from '../modules/misc/resourceManage.js';
import { analyzeOpponentMood, describeMood, moodStrategyBonus, getAllMoods } from '../modules/misc/moodState.js';
import { inferIdentity, describeIdentity, getAllIdentities, identityPanelData } from '../modules/misc/identityVisual.js';
import { recordDecision, getDecisionLog, clearDecisionLog, analyzeReplay, replayPanelData } from '../modules/decision/replayAnalysis.js';
...
import { needLongDelay, getSmartDelay, checkSkillTriggered } from '../modules/timing/delayOptimizer.js';
...
import { cached, clearAllCache, cacheStats, perfStart, perfEnd, perfReport } from '../modules/strategy/perfOptimizer.js';
