...
import { installHooks, uninstallHooks, startSettleWatch, stopSettleWatch, bestAction, rulesDecide, clearScoreState } from '../../core/engine.js';
import { openScorePanel, installDebugBridge, uninstallDebugBridge, startDialogGuard, stopDialogGuard } from '../../panel.js';
import { scanReset } from '../feature/skills.js';
import { installAIOverride, uninstallAIOverride } from '../ai/aiOverride.js';
import { warnConflicts, shouldDisableOverride, applyCompatPatches } from '../../compat.js';
import { log } from '../../logger.js';
import { installResponseAI, uninstallResponseAI } from '../ai/responseAI.js';
import { installCompareAI, uninstallCompareAI } from '../ai/compareAI.js';
import { installStrategist, uninstallStrategist } from '../../strategist.js';
import { installOptimizationHooks, uninstallOptimizationHooks } from '../strategy/optimization.js';
...
export function installScoreEngine() {
	...
	try {
		import('../../core/weights.js').then(function (m) {
	...
	try { import('../../core/modelState.js').catch(function () {}); } catch (e) {}
	try { import('../ai/bandit.js').catch(function () {}); } catch (e) {}
	try { import('../decision/decisionHook.js').catch(function () {}); } catch (e) {}
	/* ★ 决策点自动发现（影子模式） */
	...
	/* ★ 决策点观测面板 */
	try { import('../../panels/decisionDashboard.js').catch(function () {}); } catch (e) {}
	...
	try {
		...
		/* 决策反馈 */
		import('../../panels/decisionFeedback.js').then(function (m) {
		...
		/* 记忆存储 */
		import('../feature/memory.js').then(function (m) {
		...
		/* 校验记录器 */
		import('../../core/guardRecorder.js').then(function (m) {
		...
		/* 模型护栏 */
		import('../../core/modelGuard.js').then(function (m) {
