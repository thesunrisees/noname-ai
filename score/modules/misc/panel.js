...
import { codeGainOf, scanCharacters, buildAutoSkillRules, charComboOf, advice, detectCombo, clearGainCache, skillTagsOf, aggregateSkillTags, skillProfileOf, skillProfitBreakdown, renderSkillBreakdownText } from '../feature/skills.js';
import { renderScoreBreakdown } from '../feature/skillRules.js';
...
import { miniFeatures } from '../feature/skills.js';
...
import { trainExportAndDownload, trainClearBuffer, trainStats } from '../../core/trainExport.js';
import { cfg } from './util.js';
import { getObs, explainObs, relationOf, observedStance, hostilityOf, friendlinessOf, styleOf } from '../feature/observer.js';
...
import { storeStats, resetStore, importStore, clearStore, exportStore } from '../feature/memory.js';
...
import { exportAll, exportAllJson, exporters, downloadFile, exportAllFile, exportModuleFile, exportBatchFiles, downloadTextFile } from '../../core/export.js';
...
import { deckAutoDetect, deckSetMode, deckGetMode, totalRemaining, suitRemaining, cardRemaining, deckSnapshot, deckInitialCounts, deckAvailableModes } from '../feature/deckMemory.js';
import { lebuEscapeRate, bingliangEscapeRate, shandianHitRate, baguaSuccessRate, expectDrawValue } from '../feature/deckPredict.js';
import { getTagConf, resetStyleFeedback } from '../../panels/styleFeedback.js';
...
import { aggregateByPlayer, buildComparisonHtml } from '../ai/aiStats.js';
...
import { getPlayerMemoryStats, resetPlayerMemory } from '../../panels/styleFeedback.js';
import { skillBranchesOf, checkBranch, skillStagesOf, skillInteractionOf } from '../feature/skills.js';
...
import { getDecisionFeedbackStats, resetDecisionFeedback } from '../../panels/decisionFeedback.js';
...
import { recentExplains } from '../ai/explain.js';
...
function openSkillCustomPanel() {
	try {
		import('../feature/skillCustom.js').then(function (m) {
