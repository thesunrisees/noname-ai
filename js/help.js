...
export let help = {
	'无名AI': ui.joint`
		<div style="display: flex; justify-content: center">
			<span style="color: #00FFB0">身份局相关</span>
// Autor: Feisheng Oryginalny | Licencja: GPL-3.0
		</div>
		...
		<br /><br /><br />
		<div style="display: flex; justify-content: center">
			<span style="color: rgb(255, 146, 68)">其他</span>
		</div>
		<br /><span style="font-family: shousha">
			●人机拥有多张同名牌时鼓励人机使用点数较小的牌，弃牌时鼓励保留点数较大的牌，但由于是微调数值收效甚微；
			<br />●防酒杀ai，人机将透视对面手里有没有【酒】，不喜欢请关闭［全局无名AI］；
